...
Note marginale générée lors de la citation d’un texte.
...
Si vous faites un usage intensif de ces fichiers, vous pouvez les citer en vous référant à cette page web : Premat, Timothée (2024). “Fichiers .bib pour le NCA”. Consulté le XX/XX/XXXX. Url : https://phonodiachro.hypotheses.org/?page_id=1291.

Notez que je ne peux garantir l’exactitude de toutes les informations de ces notices, et que ce travail a été effectué indépendamment de l’équipe du NCA.

Abréviations utilisées dans les métadonnées

Les notices s’impriment ainsi : ID : Auteur (date de composition). Titre. Ms. [x] ; Dees : [région] ; compo. [région] [date] ; ms. [région] [date] ; MS[1-3]/CR[1-3] ([éd.]), DEAF : [identifiant DEAF].
...
ce qui imprime en note : Jean de Meun (1288*). Traduction de la première épitre de P. Abélard. Dees : région parisienne ; compo. frc., ca 1280 ; ms. Paris, ca 1395 ; MS3 (Jean de Meun 1934).
et qui imprime la même notice dans l’annexe de composition du corpus
et qui imprime dans la bibliographie générale : Jean de Meun (1934). Traduction de la première épitre de P. Abélard. Éd. Charlotte Charrier. Paris : Honoré Champion.
...
Utilisation de base : \footnote{\fullcite{}}
...
Utilisation des fichiers .bib avec \footnote{\fullcite{}}.
...
L’ensemble vous donne la liste (textes du corpus puis bibliographie) de 24 pages (!) consultable avec ce lien.
